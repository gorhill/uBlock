...
assets=(
    ...
    ['thirdparties/gitorious.org/adblock-latvian/adblock-latvian/raw/master_lists/latvian-list.txt']='https://notabug.org/latvian-list/adblock-latvian/raw/master/lists/latvian-list.txt'
    ...
    ['thirdparties/www.fanboy.co.nz/r/fanboy-ultimate.txt']='https://www.fanboy.co.nz/r/fanboy-ultimate.txt'
