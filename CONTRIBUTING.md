...
For **support/discussions**, there is [Mozilla Discourse](https://discourse.mozilla-community.org/t/support-ublock-origin/6746). **Opening an issue for purpose of support or discussion will result in the user being immediately blocked.** No excuse will be accepted.

For **filter-related issues**, report on the respective filter list support site, or at [uBlockOrigin/uAssets](https://github.com/uBlockOrigin/uAssets/issues). **Opening an issue for filter-related issues will result in the user being immediately blocked.** No excuse will be accepted.
