...
- [Implement domain-based clicking exception](https://github.com/dhowe/AdNauseam/pull/2788)
- [Improve ad collection on iframe](https://github.com/dhowe/AdNauseam/pull/2791)
...
- [Merge to uBlock Origin v1.69.0](https://github.com/dhowe/AdNauseam/pull/2763)
- [Improve ad parsing](https://github.com/dhowe/AdNauseam/pull/2766)
...
- Update list of filters that generate "adn-allow"
- Improve logging for ad parsing
- Allow ad collection when "ad hiding" is disabled
- Merge to uBlock Origin v1.69.0
...
- [Adjust badge icon and clicked count on vault button](https://github.com/dhowe/AdNauseam/pull/2746)
...
- [Fix old reddit false positive ad collection](https://github.com/dhowe/AdNauseam/pull/2701)
- Fix youtube issues
...
- [Merge to uBlock Origin v1.64.0](https://github.com/dhowe/AdNauseam/pull/2656)
- [Reduce divergence to uBlock code](https://github.com/dhowe/AdNauseam/pull/2659)
...
- Merge to uBlock Origin v1.64.0
...
- [Fix uboErr issue](https://github.com/dhowe/AdNauseam/pull/2617)
- [Add template for page broken](https://github.com/dhowe/AdNauseam/pull/2620)
- [Update locales](https://github.com/dhowe/AdNauseam/pull/2621)
- [Fix apolloduck.co.uk](https://github.com/dhowe/AdNauseam/pull/2623)
